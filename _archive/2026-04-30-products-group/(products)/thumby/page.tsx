/**
 * Thumby Consumer Marketing Page
 *
 * Partnership-focused landing page for AI thumbnail generation system.
 * Emphasizes scale, brand consistency, and rapid deployment.
 *
 * Route: /thumby
...
import { Image as ImageIcon, Sparkles, Layout, Clock, ArrowRight, Check, X, Zap } from 'lucide-react';
import { ASCIIUnifiedGrid } from '@/components/visual';
import { watercolorThemes } from '@/lib/theme/watercolor-palette';
import { ButtonPrimary, ButtonSecondary } from '@/components/ui/ButtonHierarchy';
import { fuboMarketingContent } from '@/lib/content/products/fubo-marketing';

export const metadata: Metadata = {
  title: fuboMarketingContent.seo.title.replace('Fubo', 'Thumby'),
  description: fuboMarketingContent.seo.description.replace('Fubo', 'Thumby'),
  keywords: fuboMarketingContent.seo.keywords,
  openGraph: {
    title: fuboMarketingContent.seo.title.replace('Fubo', 'Thumby'),
    description: fuboMarketingContent.seo.description.replace('Fubo', 'Thumby'),
    type: 'website',
...
export default function ThumbyProductPage() {
  const content = fuboMarketingContent;
    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white">
      ...
      <section className="relative pt-8 pb-16 md:pt-12 md:pb-24 lg:pt-16 lg:pb-32 px-4 sm:px-6 lg:px-8 border-b border-gray-800">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          {/* Product Name */}
          <div className="mb-6">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight text-purple-400">
              THUMBY
            </h1>
          </div>
          ...
          {/* Pre-headline */}
          <div className="mb-4">
            <span className="inline-block px-4 py-1.5 bg-purple-500/10 border border-purple-500/30 rounded-full text-sm font-semibold text-purple-400 uppercase tracking-wide">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="aspect-video bg-gray-800/50 border border-purple-500/30 rounded-lg flex items-center justify-center">
      ...
      <section className="relative py-16 md:py-24 px-4 sm:px-6 lg:px-8 border-b border-gray-800">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <p className="text-xl md:text-2xl text-purple-400 font-semibold italic">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
            {content.solution.useCases.map((useCase, index) => {
              const icons = [<Sparkles key={0} className="w-6 h-6" />, <Layout key={1} className="w-6 h-6" />, <Zap key={2} className="w-6 h-6" />, <ImageIcon key={3} className="w-6 h-6" />];
              return (
                <div key={index} className="p-6 lg:p-8 bg-gray-900/70 border border-purple-500/30 rounded-lg">
                  <div className="space-y-4">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="text-purple-400">
                        {icons[index] || <Sparkles className="w-6 h-6" />}
                      </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {content.proof.outcomes.map((outcome, index) => (
              <div key={index} className="p-6 bg-gray-900/70 border border-purple-500/30 rounded-lg text-center">
      ...
      <section className="relative py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-500/10 to-transparent border-b border-gray-800">
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <ButtonPrimary
            ...
            size="lg"
            className="gap-2 inline-flex items-center shadow-xl shadow-purple-500/30 mb-6 bg-purple-600 hover:bg-purple-700"
          >
      ...
      <section className="relative py-16 md:py-24 px-4 sm:px-6 lg:px-8 border-b border-gray-800">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Personas */}
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-purple-400 mb-6">Perfect if you:</h3>
          ...
          {content.howItWorks.techSidebar && (
            <div className="p-6 bg-gray-900/70 border border-gray-700 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-white mb-2">AI Technology</h4>
                  ...
                  {content.howItWorks.deepDiveLink && (
                    <Link
                      ...
                      className="text-sm text-purple-400 hover:underline inline-flex items-center gap-2"
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {content.secondaryCTAs.paths.map((path, index) => (
              <Link
                key={index}
                href={path.href}
                className="group p-6 bg-gray-900/50 border border-purple-500/50 rounded-lg transition-all flex flex-col"
              >
      ...
      <div className="py-8 px-4 text-center border-t border-gray-800">
        <p className="text-sm text-gray-500">
          Thumby Thumbnail System • Built by Rationale Studio
        </p>
      </div>
    </main>
  );
