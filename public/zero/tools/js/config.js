...
const DashboardConfig = {
  ...
  environment: (() => {
    ...
    // Use production mode for rationale-public demos (backend services not running locally)
    if (hostname === 'localhost' || hostname === '127.0.0.1') {
      return 'production'; // Changed from 'development' to use Cloud Run services
    }
