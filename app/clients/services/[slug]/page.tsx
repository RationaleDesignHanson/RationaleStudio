...
export default async function KitDetailPage({ params }: KitPageProps) {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white">
      ...
      {/* Overview - Pricing, Duration, Perfect For */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <ASCIIUnifiedGrid
            opacity={0.06}
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <OS8Window
              ...
              animateIn={false}
            >
              <div className="text-3xl sm:text-4xl font-bold text-[#FFD700] mb-2">{kit.pricing}</div>
              <p className="text-sm text-gray-300">Fixed price engagement</p>
            </OS8Window>
            ...
            <OS8Window
              ...
              animateIn={false}
            >
              <div className="text-3xl sm:text-4xl font-bold text-[#FFD700] mb-2">{kit.duration}</div>
              <p className="text-sm text-gray-300">Start to delivery</p>
            </OS8Window>
            ...
            <OS8Window
              ...
              animateIn={false}
            >
              <div className="text-xl sm:text-2xl font-bold text-[#FFD700] mb-2">Remote + Async</div>
              <p className="text-sm text-gray-300">Flexible collaboration</p>
            </OS8Window>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {kit.deliverables.map((deliverable, index) => (
              <div
                key={index}
                className="flex gap-3 p-6 rounded-lg border border-gray-700 bg-black/40"
              >
                <div className="flex-shrink-0 w-8 h-8 rounded bg-[#FFD700]/10 flex items-center justify-center">
      ...
      {kit.process && kit.process.length > 0 && (
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
            <ASCIIUnifiedGrid
              opacity={0.06}
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              {kit.process.map((step, index) => (
                <div key={index} className="relative">
                  {/* Connecting Line (except for last item) */}
                  {index < kit.process!.length - 1 && (
                    <div className="absolute left-8 top-full h-8 w-0.5 bg-[#FFD700]/30 z-0" />
                  )}

                  <div className="relative flex gap-6">
                    {/* Step Number */}
                    <div className="flex-shrink-0 w-16 h-16 rounded-full bg-[#FFD700] text-black flex items-center justify-center font-bold text-xl shadow-lg">
                      {index + 1}
                    </div>
      ...
      {/* ICP Targeting - Ideal For / Not Ideal For */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <ASCIIUnifiedGrid
            opacity={0.06}
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Ideal For */}
            {kit.idealFor && kit.idealFor.length > 0 && (
              <div>
            ...
            {/* Not Ideal For */}
            {kit.notIdealFor && kit.notIdealFor.length > 0 && (
              <div>
                <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
                ...
                <div className="space-y-3">
                  {kit.notIdealFor.map((item, index) => (
                    <div
                      key={index}
            ...
            {(!kit.idealFor || kit.idealFor.length === 0) && kit.perfectFor && (
              <div className="md:col-span-2 max-w-3xl mx-auto">
                <h3 className="text-lg font-bold text-white mb-4 text-center">
                  Perfect For
                </h3>
                <div className="space-y-3">
                  {kit.perfectFor.map((item, index) => (
                    <div
                      key={index}
                      className="flex gap-3 p-4 rounded-lg border border-gray-700 bg-black/40"
                    >
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            >
              <p className="text-base sm:text-lg text-gray-300 mb-6">
                {kit.caseStudy.description}
              </p>
              <div className="p-6 rounded-lg bg-[#FFD700]/5 border border-[#FFD700]/20 mb-6">
                <h4 className="text-sm font-semibold uppercase tracking-wide text-[#FFD700] mb-2">
                  Outcome
                </h4>
                <p className="text-sm sm:text-base text-white leading-relaxed">
                  {kit.caseStudy.outcome}
                </p>
              </div>
              {kit.caseStudy.link && (
                <Link
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-center">
              Other Kits You Might Consider
            </h2>
            <p className="text-center text-gray-400 mb-12 max-w-2xl mx-auto">
              Not sure this is the right fit? Here are other ways we can help:
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {relatedKits.map((relatedKit) => (
                ...
                >
                  ...
                  >
                    <p className="text-sm text-[#FFD700] font-medium mb-3">
                      {relatedKit.tagline}
                    </p>
                    <p className="text-xs text-gray-400 mb-4 line-clamp-3">
                      {relatedKit.description}
                    </p>
                    <div className="flex items-center justify-between text-xs text-gray-400">
                      <span>{relatedKit.duration}</span>
          ...
          >
            <div className="space-y-6">
              <p className="text-base text-[#FFD700] leading-relaxed text-center">
                Let's talk about your project. We'll walk through the details and make sure this kit is the right fit.
              </p>
