...
export default async function KitDetailPage({ params }: KitPageProps) {
  ...
  return ( <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white"> {/* Hero */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
          ...
          /> </div> <div className="relative z-10 max-w-6xl mx-auto"> <div className="grid lg:grid-cols-3 gap-6"> {/* Pricing */} <OS8Window
              ...
              variant="body"
              animateIn={false}
            > <div className="text-3xl sm:text-4xl font-bold text-terminal-gold mb-2">{kit.pricing}</div> <p className="text-sm text-gray-300">Fixed price engagement</p> </OS8Window> {/* Duration */} <OS8Window
              title="Timeline"
              variant="body"
              animateIn={false}
            > <div className="text-3xl sm:text-4xl font-bold text-terminal-gold mb-2">{kit.duration}</div> <p className="text-sm text-gray-300">Start to delivery</p> </OS8Window> {/* Format */} <OS8Window
              title="Format"
              variant="body"
              animateIn={false}
