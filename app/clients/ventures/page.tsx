...
export default function VenturesHubPage() {
  return ( <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white"> {/* Hero */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
          ...
          /> </div> <div className="relative z-10 max-w-5xl mx-auto"> <p className="text-xs sm:text-sm font-mono text-terminal-gold tracking-widest mb-4 text-center animate-fade-in-up"> CONVICTION-BACKED VENTURES WE ORIGINATE AND OWN </p> <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-center animate-fade-in-up delay-100"> Portfolio IP </h1> <p className="text-lg sm:text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto text-center mb-8 animate-fade-in-up delay-200"> IP designed to appreciate over time, not trade hours. One engine of our dual-model studio. Zero is live on App Store—1 month from concept to complete plan. Project Atlas and Project Amplify have full roadmaps. This is what conviction looks like: working software, systematic execution, IP accumulation. </p> {/* Dual-Engine Context */} <div className="max-w-4xl mx-auto mb-8"> <OS8Window
              ...
              variant="body"
              animateIn={false}
            > <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-100 mb-4"> <div> <p className="mb-2"> <span className="font-bold text-terminal-gold">Portfolio IP</span> (this page): Ventures we originate and own. Built with conviction, designed to appreciate over time. </p> </div> <div> <p className="mb-2"> <span className="font-bold text-terminal-gold">Rationale Kits</span> <Link href="/partnerships" className="text-terminal-gold hover:underline">(see kits)</Link>: Client engagements that fund runway, validate systems, generate market data. </p> </div> </div> <p className="text-xs text-center text-gray-300 pt-4 border-t border-terminal-gold/20"> <span className="font-bold text-white">Result:</span> Kits fund exploration. Portfolio proves conviction. Both compound our execution capability. Systematic IP accumulation. </p> </OS8Window> </div> {/* Quick Stats */} <div className="max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-4"> <div className="p-4 rounded-lg border border-terminal-gold/20 bg-black/60 backdrop-blur-sm text-center"> <div className="text-2xl font-bold text-terminal-gold">3</div> <div className="text-xs text-gray-300">Active Ventures</div> </div> <div className="p-4 rounded-lg border border-terminal-gold/20 bg-black/60 backdrop-blur-sm text-center"> <div className="text-2xl font-bold text-terminal-gold">1 mo</div> <div className="text-xs text-gray-300">Concept to Plan</div> </div> <div className="p-4 rounded-lg border border-terminal-gold/20 bg-black/60 backdrop-blur-sm text-center"> <div className="text-2xl font-bold text-terminal-gold">350KB+</div> <div className="text-xs text-gray-300">Documentation</div> </div> <div className="p-4 rounded-lg border border-terminal-gold/20 bg-black/60 backdrop-blur-sm text-center"> <div className="text-2xl font-bold text-terminal-gold">7</div> <div className="text-xs text-gray-300">Working Prototypes</div> </div> </div> </div> </section> {/* Zero - Featured Venture */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            opacity={0.06}
            animated={true}
