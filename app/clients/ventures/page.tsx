...
export default function VenturesHubPage() {
  return ( <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white"> {/* Hero */} <section className="relative py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-4 sm:px-6 md:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            ...
            charSet="default"
          /> </div> <div className="relative z-10 max-w-5xl mx-auto"> <p className="text-xs sm:text-sm font-mono text-terminal-gold tracking-widest mb-4 text-center animate-fade-in-up"> CONVICTION-BACKED VENTURES WE ORIGINATE AND OWN </p> <h1 className="text-2xl md:text-3xl lg:text-4xl sm:text-5xl md:text-2xl md:text-3xl lg:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-center animate-fade-in-up delay-100"> Portfolio IP </h1> <p className="text-lg sm:text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto text-center mb-8 animate-fade-in-up delay-200"> IP designed to appreciate over time, not trade hours. One engine of our dual-model studio. Zero is live on App Store—1 month from concept to complete plan. Project Atlas and Project Amplify have full roadmaps. This is what conviction looks like: working software, systematic execution, IP accumulation. </p> {/* Dual-Engine Context */} <div className="max-w-4xl mx-auto mb-8"> <OS8Window
              title="Portfolio IP + Kits: How Our Dual-Engine Model Works"
              variant="body"
              animateIn={false}
            > <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-100 mb-4"> <div> <p className="mb-2"> <span className="font-bold text-terminal-gold">Portfolio IP</span> (this page): Ventures we originate and own. Built with conviction, designed to appreciate over time. </p> </div> <div> <p className="mb-2"> <span className="font-bold text-terminal-gold">Rationale Kits</span> <Link href="/partnerships" className="text-terminal-gold hover:underline">(see kits)</Link>: Client engagements that fund runway, validate systems, generate market data. </p> </div> </div> <p className="text-xs text-center text-gray-300 pt-4 border-t border-terminal-gold/20"> <span className="font-bold text-white">Result:</span> Kits fund exploration. Portfolio proves conviction. Both compound our execution capability. Systematic IP accumulation. </p> </OS8Window> </div> {/* Quick Stats */} <div className="max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-4"> <div className="p-4 rounded-lg border border-terminal-gold/20 bg-black/60 backdrop-blur-sm text-center"> <div className="text-2xl font-bold text-terminal-gold">3</div> <div className="text-xs text-gray-300">Active Ventures</div> </div> <div className="p-4 rounded-lg border border-terminal-gold/20 bg-black/60 backdrop-blur-sm text-center"> <div className="text-2xl font-bold text-terminal-gold">1 mo</div> <div className="text-xs text-gray-300">Concept to Plan</div> </div> <div className="p-4 rounded-lg border border-terminal-gold/20 bg-black/60 backdrop-blur-sm text-center"> <div className="text-2xl font-bold text-terminal-gold">350KB+</div> <div className="text-xs text-gray-300">Documentation</div> </div> <div className="p-4 rounded-lg border border-terminal-gold/20 bg-black/60 backdrop-blur-sm text-center"> <div className="text-2xl font-bold text-terminal-gold">7</div> <div className="text-xs text-gray-300">Working Prototypes</div> </div> </div> </div> </section> {/* Zero - Featured Venture */} <section className="relative py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-4 sm:px-6 md:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            opacity={0.06}
            animated={true}
          ...
          /> </div> <div className="relative z-10 max-w-5xl mx-auto"> <div className="text-center mb-8"> <h2 className="text-2xl sm:text-3xl font-bold mb-2">Featured Venture</h2> <p className="text-base text-gray-300">Full transparency: complete roadmap, metrics, and technical details</p> </div> <OS8Window
            ...
            variant="featured"
            animateIn={false}
          > <div className="flex items-start gap-6 mb-6"> <div className="flex-shrink-0 w-16 h-16 rounded-lg bg-terminal-gold/20 flex items-center justify-center"> <span className="text-3xl"></span> </div> <div className="flex-1"> <div className="flex flex-wrap items-center gap-3 mb-3"> <span className="px-3 py-1 rounded-full bg-terminal-gold/20 text-terminal-gold text-xs font-medium">Live on App Store</span> <Link
                    href="/invest/zero"
                  ...
                  > Seed Round: $600K </Link> </div> <p className="text-base text-gray-100 mb-6"> Helping healthcare providers save 2-3 hours per day on email-driven documentation. From concept to complete execution plan in 1 month—97% size reduction, 67% faster builds, 7 interactive prototypes. </p> <div className="grid sm:grid-cols-4 gap-4 mb-6"> <div className="text-center"> <div className="text-2xl font-bold text-terminal-gold">97%</div> <div className="text-xs text-gray-300">Size Reduction</div> </div> <div className="text-center"> <div className="text-2xl font-bold text-terminal-gold">67%</div> <div className="text-xs text-gray-300">Build Speed</div> </div> <div className="text-center"> <div className="text-2xl font-bold text-terminal-gold">7</div> <div className="text-xs text-gray-300">Prototypes</div> </div> <div className="text-center"> <div className="text-2xl font-bold text-terminal-gold">116KB</div> <div className="text-xs text-gray-300">Roadmap Docs</div> </div> </div> <div className="flex flex-col sm:flex-row gap-4"> <ButtonPrimary href="/ventures/zero" size="md"> View Product Page → </ButtonPrimary> <ButtonSecondary href="/invest/zero" size="md"> Seed Round: $600K </ButtonSecondary> <ButtonSecondary href="/client/zero/dashboard" size="md"> Full Dashboard </ButtonSecondary> </div> </div> </div> </OS8Window> </div> </section> {/* Stealth Ventures */} <section className="relative py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-4 sm:px-6 md:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            opacity={0.06}
            animated={true}
          ...
          /> </div> <div className="relative z-10 max-w-5xl mx-auto"> <div className="text-center mb-12"> <div className="inline-flex items-center px-4 py-2 rounded-full bg-yellow-500/20 text-yellow-400 text-sm font-medium mb-4"> Partnership Phase Ventures </div> <h2 className="text-2xl sm:text-3xl font-bold mb-3">Two More in Active Partnership Phase</h2> <p className="text-base text-gray-300">Complete roadmaps and technical architecture. Partnership + capital opportunities available to qualified partners.</p> </div> <div className="grid md:grid-cols-2 gap-6"> {/* Project Atlas */} <OS8Window
              ...
              variant="interactive"
              animateIn={false}
            > <div className="flex items-start gap-4 mb-4"> <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-terminal-gold/10 flex items-center justify-center"> <span className="text-2xl"></span> </div> <div className="flex-1"> <div className="flex flex-wrap items-center gap-2 mb-2"> <Link
                      href="/invest/atlas"
