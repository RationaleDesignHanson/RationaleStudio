...
export default function SolutionSlidePage() {
  ...
  return (
    ...
    >
      {/* Platform Overview */}
      <CRECard variant="secondary" size="large" className="mb-8">
        <div className="text-center mb-8">
          <H2 className="mb-4">CREaiT Platform</H2>
          <BodyLG color={CRE_COLORS.text.secondary}>
            From 30 minutes of manual research to 30 seconds of actionable intelligence
          </BodyLG>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {coreFeatures.map((feature, index) => (
            ...
            >
              ...
              <BodyMD color={CRE_COLORS.text.secondary} className="mb-4 flex-1">
                {feature.description}
              </BodyMD>
              <div className="pt-4 border-t border-white/10 w-full">
                <DataMD color={CRE_COLORS.secondary}>{feature.metric}</DataMD>
      ...
      <div className="mt-12">
        <H2 className="mb-4 text-center">How CREaiT Works</H2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
        <CRECard variant="accent" interactive>
          <LabelSM color={CRE_COLORS.accent}>EFFICIENCY</LabelSM>
          <H3 className="my-3">60x Faster Research</H3>
        ...
        <CRECard variant="accent" interactive>
          <LabelSM color={CRE_COLORS.accent}>PRIORITY</LabelSM>
          <H3 className="my-3">Data-Driven Focus</H3>
          <BodyMD color={CRE_COLORS.text.secondary}>
            AI scoring helps brokers contact the right people at the right time
          </BodyMD>
        </CRECard>

        <CRECard variant="accent" interactive>
          <LabelSM color={CRE_COLORS.accent}>TIMING</LabelSM>
          <H3 className="my-3">Never Miss a Window</H3>
          <BodyMD color={CRE_COLORS.text.secondary}>
            Automated tracking of critical events ensures perfect timing
          </BodyMD>
        </CRECard>
      </div>
    </CRESection>
