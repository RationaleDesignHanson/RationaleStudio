      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-4 sm:px-6 md:px-8 border-b border-gray-800">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed max-w-3xl mb-6">
            {' '}
            AI-powered sports thumbnail generation with 24 visual styles, enabling scalable content
            ...
            <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
              ...
              <div className="space-y-3 text-sm text-gray-300">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    {' '}
                    Input: Base image + style references + weights → Output: Stylized thumbnail{' '}
                  </p>{' '}
                </div>{' '}
              </div>{' '}
            </div>{' '}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 p-6 bg-gray-900/30 border border-gray-800 rounded-lg">
            ...
            <p className="text-sm text-gray-400">
              {' '}
              <span className="font-semibold text-white">Timeline:</span> Complete system delivered
              in 2-week strategic sprint from concept to working prototype with full feature set and
              documentation.{' '}
            </p>{' '}
          </div>{' '}
        </div>{' '}
