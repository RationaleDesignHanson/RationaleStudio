        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            >
              {/* Trust Signals */}
              {status !== 'success' && (
                <div className="mb-8 pb-6 border-b border-[#FFD700]/20">
                  <div className="grid md:grid-cols-3 gap-4 text-center md:text-left">
                    <div className="flex items-center justify-center md:justify-start gap-2">
                      <svg className="w-5 h-5 text-[#FFD700] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  {contactContent.form.fields.map((field) => {
                    ...
                    return (
                      <div key={field.name}>
                        ...
                        >
                          {field.label}
                          {field.required && <span className="text-[#FFD700] ml-1" aria-label="required">*</span>}
                        </label>
            ...
            <div className="mt-12 text-center">
              ...
              <a
                ...
                className="text-xl font-medium text-[#FFD700] hover:underline"
              >
