...
export default function AmplifyInvestmentPage() {
  return ( <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white"> {/* Hero */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
          ...
          /> </div> <div className="relative z-10 max-w-7xl mx-auto"> <div className="mb-6"> <Link href="/invest" className="text-[#FFD700] hover:underline text-sm"> ← Back to Investment Opportunities </Link> </div> <div className="grid lg:grid-cols-3 gap-8"> {/* Main Content */} <div className="lg:col-span-2"> <OS8Window
                ...
                variant="featured"
                animateIn={false}
              > <div className="flex items-center gap-3 mb-6"> <span className="px-4 py-2 rounded-full bg-yellow-500/20 text-yellow-400 border border-yellow-500/30 text-sm font-medium"> Pre-Build · Partnership Opportunity </span> </div> <p className="text-xl text-[#FFD700] font-medium mb-4"> Partnership + Capital Opportunity · 16-Week MVP </p> <p className="text-base text-gray-100 mb-8"> Complete athlete management platform for sports agents. NIL compliance, AI-powered recruiting, content generation, and blockchain rights verification. Seeking agency partner network + capital to execute 4-module system designed to scale personal attention across 50+ athletes. </p> {/* Key Stats */} <div className="grid grid-cols-3 gap-4 mb-6"> <div className="p-4 rounded-lg border border-[#FFD700]/20 bg-black/40 text-center"> <div className="text-2xl font-bold text-[#FFD700]">$60-250K</div> <div className="text-xs text-gray-300">Budget Range</div> </div> <div className="p-4 rounded-lg border border-[#FFD700]/20 bg-black/40 text-center"> <div className="text-2xl font-bold text-[#FFD700]">16 wk</div> <div className="text-xs text-gray-300">MVP Timeline</div> </div> <div className="p-4 rounded-lg border border-[#FFD700]/20 bg-black/40 text-center"> <div className="text-2xl font-bold text-[#FFD700]">129KB</div> <div className="text-xs text-gray-300">Complete Blueprint</div> </div> </div> <div className="p-4 rounded-lg bg-yellow-900/20 border border-yellow-500/30"> <p className="text-sm text-yellow-100"> <span className="font-bold">Documentation Complete:</span> Full project blueprint (3,556 lines), 16-week execution plan, technical architecture for 4 modules, user stories for 3 personas, and CEO checkpoint templates. </p> </div> </OS8Window> </div> </div> </div> </section> {/* Market Opportunity */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            opacity={0.06}
            animated={true}
          ...
          /> </div> <div className="relative z-10 max-w-4xl mx-auto"> <h2 className="text-3xl sm:text-4xl font-bold mb-4"> Market Opportunity </h2> <p className="text-base text-gray-300 mb-8"> 800+ agents compete for 250 NFL draft spots annually. Most invest $15K-$25K per prospect with no guarantee of signing. Once signed, agents manage 30-40+ clients with 24/7 availability expectations. The NIL era added new complexity: athletes need help navigating brand deals, content creation, and rights management. </p> <div className="grid md:grid-cols-2 gap-6 mb-8"> <OS8Window
            ...
            > <div className="text-lg font-bold text-white mb-3">Agents Can't Scale</div> <div className="text-sm text-gray-300"> Traditional agency workflows (email threads, manual verification) take 2-3 weeks—too slow for cultural moments with 48-72 hour windows. Agencies must choose between staying boutique (capped revenue) or scaling (losing personal touch). </div> </OS8Window> <OS8Window
              ...
              variant="body"
              animateIn={false}
            > <div className="text-lg font-bold text-white mb-3">Athlete Operating System</div> <div className="text-sm text-gray-300"> The first to deliver boutique-level personalization at league-level scale wins the next decade. AI-powered workflows enable 4-module integrated platform that handles recruiting, NIL, content, and rights management. </div> </OS8Window> </div> <div className="p-6 rounded-lg border-2 border-[#FFD700]/30 bg-black/40"> <h3 className="text-lg font-bold text-white mb-3">Target Market</h3> <ul className="text-sm text-gray-100 space-y-2"> <li>• Sports agencies managing 30-50+ athletes across football, basketball, baseball</li> <li>• Individual agents seeking competitive advantage in recruiting battles</li> <li>• NIL collectives and athlete management firms needing compliance infrastructure</li> <li>• Active customer development conversations with select agencies in progress</li> </ul> </div> </div> </section> {/* Four Product Modules */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            opacity={0.06}
            animated={true}
            colorTheme={watercolorThemes.darkGalaxy}
            charSet="default"
          /> </div> <div className="relative z-10 max-w-4xl mx-auto"> <h2 className="text-3xl sm:text-4xl font-bold mb-2 text-center">Four Integrated Modules</h2> <p className="text-base text-gray-300 mb-8 text-center"> Each module solves a specific pain point. Together, they create a complete Athlete Operating System. </p> <div className="space-y-6"> <OS8Window
              title=" RecruitAI"
              variant="featured"
              animateIn={false}
              className="border-2 border-[#FFD700]/30"
            > <p className="text-sm text-[#FFD700] font-medium mb-3">Early identification and predictive modeling</p> <p className="text-sm text-gray-300 mb-4"> AI-powered prospect identification using 23 performance signals, social media engagement, injury history. Predictive models reduce failed bets by 60%. Identify tomorrow's stars before competitors. </p> <div className="flex flex-wrap gap-2"> <span className="px-2 py-1 text-xs rounded bg-[#FFD700]/10 text-[#FFD700] border border-[#FFD700]/20">Performance Analytics</span> <span className="px-2 py-1 text-xs rounded bg-[#FFD700]/10 text-[#FFD700] border border-[#FFD700]/20">Social Sentiment</span> <span className="px-2 py-1 text-xs rounded bg-[#FFD700]/10 text-[#FFD700] border border-[#FFD700]/20">Injury Risk Modeling</span> </div> </OS8Window> <OS8Window
              title=" Immersive Pitch"
              variant="body"
              animateIn={false}
            > <p className="text-sm text-[#FFD700] font-medium mb-3">AR-powered recruiting presentations</p> <p className="text-sm text-gray-300 mb-4"> Augmented reality pitch decks showcasing contract value predictions, career trajectory modeling, brand partnership potential. Show prospects their future—literally. Stand out in recruiting battles. </p> <div className="flex flex-wrap gap-2"> <span className="px-2 py-1 text-xs rounded bg-[#FFD700]/10 text-[#FFD700] border border-[#FFD700]/20">AR Visualization</span> <span className="px-2 py-1 text-xs rounded bg-[#FFD700]/10 text-[#FFD700] border border-[#FFD700]/20">Career Path Modeling</span> <span className="px-2 py-1 text-xs rounded bg-[#FFD700]/10 text-[#FFD700] border border-[#FFD700]/20">Interactive Deck</span> </div> </OS8Window> <OS8Window
              title=" NIL Compliance Platform"
              variant="body"
              animateIn={false}
            > <p className="text-sm text-[#FFD700] font-medium mb-3">Blockchain rights verification and deal management</p> <p className="text-sm text-gray-300 mb-4"> Instant rights verification (&lt;10 seconds vs 2-3 weeks), smart contract automation, brand deal tracking. Protect athlete IP, accelerate deal flow, prevent unauthorized usage. The infrastructure layer for NIL. </p> <div className="flex flex-wrap gap-2"> <span className="px-2 py-1 text-xs rounded bg-[#FFD700]/10 text-[#FFD700] border border-[#FFD700]/20">Blockchain Registry</span> <span className="px-2 py-1 text-xs rounded bg-[#FFD700]/10 text-[#FFD700] border border-[#FFD700]/20">Smart Contracts</span> <span className="px-2 py-1 text-xs rounded bg-[#FFD700]/10 text-[#FFD700] border border-[#FFD700]/20">Usage Monitoring</span> </div> </OS8Window> <OS8Window
              title=" AmplifyAI"
              variant="body"
              animateIn={false}
            > <p className="text-sm text-[#FFD700] font-medium mb-3">AI-powered content generation for cultural moments</p> <p className="text-sm text-gray-300 mb-4"> Turn around brand-safe content in 48-72 hours (vs 2-3 weeks). Capture viral cultural moments, maximize athlete brand value. Agent-approved workflows ensure quality while moving at internet speed. </p> <div className="flex flex-wrap gap-2"> <span className="px-2 py-1 text-xs rounded bg-[#FFD700]/10 text-[#FFD700] border border-[#FFD700]/20">Rapid Content Gen</span> <span className="px-2 py-1 text-xs rounded bg-[#FFD700]/10 text-[#FFD700] border border-[#FFD700]/20">Brand Safety</span> <span className="px-2 py-1 text-xs rounded bg-[#FFD700]/10 text-[#FFD700] border border-[#FFD700]/20">Approval Workflows</span> </div> </OS8Window> </div> </div> </section> {/* Budget & Timeline */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            opacity={0.06}
            animated={true}
            colorTheme={watercolorThemes.terminalSubtle}
            charSet="default"
