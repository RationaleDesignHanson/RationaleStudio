  ...
  return ( <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white"> {/* Hero */} <section className="relative py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-4 sm:px-6 md:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
          ...
          /> </div> <div className="relative z-10 max-w-4xl mx-auto"> <h2 className="text-3xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-8">Platform Features (12-Week MVP)</h2> <div className="grid md:grid-cols-2 gap-6 mb-8"> <OS8Window
            ...
            > <p className="text-sm text-gray-300 mb-4"> Draft guidance for communications with full human editability. AI suggests approach based on relationship history and market conditions. </p> <div className="text-xs text-terminal-gold font-medium">Core Feature · Week 8-10</div> </OS8Window> <OS8Window
              ...
              variant="body"
              animateIn={false}
            > <p className="text-sm text-gray-300 mb-4"> Lightweight oversight for senior team members. Review communications before sending, with context preserved and quick edit capability. </p> <div className="text-xs text-terminal-gold font-medium">Core Feature · Week 11-12</div> </OS8Window> </div> <div className="p-6 rounded-lg border border-terminal-gold/20 bg-black/40"> <h4 className="text-base font-bold text-white mb-3">Tech Stack</h4> <div className="grid sm:grid-cols-2 gap-4 text-sm text-gray-300"> <div> <p className="font-medium text-white mb-1">Data & Processing:</p> <p>PostgreSQL, Airflow, Spark, dbt, Elasticsearch</p> </div> <div> <p className="font-medium text-white mb-1">AI & Backend:</p> <p>OpenAI GPT-4, LangChain, FastAPI, Python</p> </div> </div> </div> </div> </section> {/* Budget & Timeline */} <section className="relative py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-4 sm:px-6 md:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            opacity={0.06}
            animated={true}
            colorTheme={watercolorThemes.terminalSubtle}
            charSet="default"
