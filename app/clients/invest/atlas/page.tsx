...
export default function AtlasInvestmentPage() {
  return ( <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white"> {/* Hero */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
          ...
          /> </div> <div className="relative z-10 max-w-4xl mx-auto"> <h2 className="text-3xl sm:text-4xl font-bold mb-8">Platform Features (12-Week MVP)</h2> <div className="grid md:grid-cols-2 gap-6 mb-8"> <OS8Window
              ...
              variant="body"
              animateIn={false}
            > <p className="text-sm text-gray-300 mb-4"> Ranked opportunities based on timing signals: lease maturity, debt timing, ownership changes, market activity. Brokers see what deserves attention and why. </p> <div className="text-xs text-[#FFD700] font-medium">Core Feature · Week 1-4</div> </OS8Window> <OS8Window
              title="Contextual Insight Views"
              variant="body"
              animateIn={false}
            > <p className="text-sm text-gray-300 mb-4"> Relationship and asset detail views consolidating fragmented information. All context in one place—no more switching between 5 systems. </p> <div className="text-xs text-[#FFD700] font-medium">Core Feature · Week 5-7</div> </OS8Window> <OS8Window
              title="AI-Assisted Outreach"
              variant="body"
              animateIn={false}
            > <p className="text-sm text-gray-300 mb-4"> Draft guidance for communications with full human editability. AI suggests approach based on relationship history and market conditions. </p> <div className="text-xs text-[#FFD700] font-medium">Core Feature · Week 8-10</div> </OS8Window> <OS8Window
              title="Review & Approval Workflow"
              variant="body"
              animateIn={false}
            > <p className="text-sm text-gray-300 mb-4"> Lightweight oversight for senior team members. Review communications before sending, with context preserved and quick edit capability. </p> <div className="text-xs text-[#FFD700] font-medium">Core Feature · Week 11-12</div> </OS8Window> </div> <div className="p-6 rounded-lg border border-[#FFD700]/20 bg-black/40"> <h4 className="text-base font-bold text-white mb-3">Tech Stack</h4> <div className="grid sm:grid-cols-2 gap-4 text-sm text-gray-300"> <div> <p className="font-medium text-white mb-1">Data & Processing:</p> <p>PostgreSQL, Airflow, Spark, dbt, Elasticsearch</p> </div> <div> <p className="font-medium text-white mb-1">AI & Backend:</p> <p>OpenAI GPT-4, LangChain, FastAPI, Python</p> </div> </div> </div> </div> </section> {/* Budget & Timeline */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            opacity={0.06}
            animated={true}
            colorTheme={watercolorThemes.terminalSubtle}
            charSet="default"
          /> </div> <div className="relative z-10 max-w-4xl mx-auto"> <h2 className="text-3xl sm:text-4xl font-bold mb-8">Budget & Timeline</h2> <OS8Window
            ...
            variant="body"
            animateIn={false}
          > <div className="space-y-4 mb-8"> <div className="p-4 rounded-lg border border-[#FFD700]/20 bg-black/40"> <div className="flex justify-between items-center mb-2"> <span className="text-sm font-semibold text-white">Minimum Viable</span> <span className="text-lg font-bold text-[#FFD700]">$92K</span> </div> <div className="text-xs text-gray-300"> Basic feature set, limited integrations, single brokerage pilot. </div> </div> <div className="p-4 rounded-lg border-2 border-[#FFD700] bg-[#FFD700]/5"> <div className="flex justify-between items-center mb-2"> <span className="text-sm font-semibold text-white">Recommended (Full MVP)</span> <span className="text-lg font-bold text-[#FFD700]">$165K</span> </div> <div className="text-xs text-gray-300"> All 4 core features, full CRM integration, 2-3 pilot firms, production-ready infrastructure. </div> </div> <div className="p-4 rounded-lg border border-[#FFD700]/20 bg-black/40"> <div className="flex justify-between items-center mb-2"> <span className="text-sm font-semibold text-white">Comprehensive</span> <span className="text-lg font-bold text-[#FFD700]">$247K</span> </div> <div className="text-xs text-gray-300"> Advanced features, multi-sector support, enhanced AI capabilities, comprehensive testing. </div> </div> </div> <div className="pt-6 border-t border-[#FFD700]/20"> <h4 className="text-base font-bold text-white mb-4">12-Week Timeline</h4> <div className="space-y-3 text-sm"> <div className="flex gap-4"> <span className="font-semibold text-[#FFD700] min-w-[80px]">Weeks 1-4:</span> <span className="text-gray-300">Foundation & Dashboard MVP</span> </div> <div className="flex gap-4"> <span className="font-semibold text-[#FFD700] min-w-[80px]">Weeks 5-7:</span> <span className="text-gray-300">Contextual Views & Integration</span> </div> <div className="flex gap-4"> <span className="font-semibold text-[#FFD700] min-w-[80px]">Weeks 8-10:</span> <span className="text-gray-300">AI Outreach & Communication Tools</span> </div> <div className="flex gap-4"> <span className="font-semibold text-[#FFD700] min-w-[80px]">Weeks 11-12:</span> <span className="text-gray-300">Workflow, Testing & Production Deploy</span> </div> </div> </div> </OS8Window> <div className="p-6 rounded-lg bg-black/40 border border-[#FFD700]/20 mt-6"> <h4 className="text-base font-bold text-white mb-3">What's Documented</h4> <ul className="text-sm text-gray-300 space-y-2"> <li>• Complete technical architecture (103KB, 2,634 lines of documentation)</li> <li>• Week-by-week execution plan with checkpoints and deliverables</li> <li>• Data requirements and ETL pipeline specifications</li> <li>• User stories and workflows for 3 persona types (broker, senior broker, admin)</li> <li>• CEO checkpoint templates with go/no-go criteria at weeks 4, 8, and 12</li> </ul> </div> </div> </section> {/* Partnership Structure */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            opacity={0.06}
            animated={true}
            colorTheme={watercolorThemes.darkGalaxy}
            charSet="default"
