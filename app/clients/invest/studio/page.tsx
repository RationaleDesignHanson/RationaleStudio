...
export default function StudioInvestmentPage() {
  return ( <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white"> {/* Hero */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
          ...
          /> </div> <div className="relative z-10 max-w-7xl mx-auto"> <div className="mb-6"> <Link href="/invest" className="text-[#FFD700] hover:underline text-sm"> ← Back to Investment Opportunities </Link> </div> <div className="grid lg:grid-cols-3 gap-8"> {/* Main Content */} <div className="lg:col-span-2"> <OS8Window
                ...
                variant="featured"
                animateIn={false}
              > <div className="flex items-center gap-3 mb-6"> <span className="px-4 py-2 rounded-full bg-green-500/20 text-green-400 border border-green-500/30 text-sm font-medium"> Lowest Risk · Diversified </span> </div> <p className="text-xl text-[#FFD700] font-medium mb-4"> $500K SAFE · 18-24 Month Runway </p> <p className="text-base text-gray-100 mb-8"> Your $500K Studio investment gives you proportional ownership across our entire portfolio—not just one bet. Zero shipped to App Store in 1 month. Atlas and Amplify have complete execution roadmaps ready to deploy. This isn't a mutual fund. It's an operating studio with founder DNA, building conviction-backed IP you own proportionally. </p> {/* Key Stats */} <div className="grid grid-cols-3 gap-4"> <div className="p-4 rounded-lg border border-[#FFD700]/20 bg-black/40 text-center"> <div className="text-2xl font-bold text-[#FFD700]">$500K</div> <div className="text-xs text-gray-300">SAFE Target</div> </div> <div className="p-4 rounded-lg border border-[#FFD700]/20 bg-black/40 text-center"> <div className="text-2xl font-bold text-[#FFD700]">18-24mo</div> <div className="text-xs text-gray-300">Runway</div> </div> <div className="p-4 rounded-lg border border-[#FFD700]/20 bg-black/40 text-center"> <div className="text-2xl font-bold text-[#FFD700]">2-3/yr</div> <div className="text-xs text-gray-300">Ventures Created</div> </div> </div> </OS8Window> </div> </div> </div> </section> {/* Dual-Engine Model */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            opacity={0.06}
            animated={true}
          ...
          /> </div> <div className="relative z-10 max-w-4xl mx-auto"> <h2 className="text-3xl sm:text-4xl font-bold mb-4"> How Studio Investment Works </h2> {/* Simple Explanation - Emotional First */} <p className="text-base text-gray-300 mb-8"> Your $500K Studio SAFE converts to proportional ownership across all Rationale ventures—past, present, and future. Zero is already live on App Store. Atlas and Amplify have complete roadmaps ready to deploy. You participate in 2-3 new ventures per year as we create them. </p> {/* Value Prop - Why This Beats Direct */} <OS8Window
            ...
            variant="body"
            animateIn={false}
          > <div className="grid md:grid-cols-2 gap-6"> <div> <h4 className="text-lg font-semibold text-[#FFD700] mb-3">Studio Investment</h4> <ul className="text-sm text-gray-300 space-y-2"> <li>• Own a piece of ALL portfolio ventures</li> <li>• Zero + Atlas + Amplify + 2-3 new ventures/year</li> <li>• Diversified across sectors and stages</li> <li>• Kits revenue funds operations (80%+)</li> <li>• Systematic IP creation, not one-time bet</li> </ul> </div> <div> <h4 className="text-lg font-semibold text-[#FFD700] mb-3">Direct Venture Investment</h4> <ul className="text-sm text-gray-300 space-y-2"> <li>• Higher ownership % in single venture</li> <li>• Concentrated risk/reward profile</li> <li>• Direct board participation options</li> <li>• Single market/product bet</li> <li>• Example: Zero $600K Seed Round</li> </ul> </div> </div> </OS8Window> {/* Proof Points - Execution Track Record */} <div className="p-6 rounded-lg border-2 border-[#FFD700]/30 bg-[#FFD700]/5 mb-8 mt-6"> <h4 className="text-lg font-bold text-white mb-3"> Proof of Systematic Execution </h4> <div className="grid md:grid-cols-3 gap-6"> <div> <div className="text-2xl font-bold text-[#FFD700] mb-1">1 month</div> <div className="text-sm text-gray-300">Zero: Concept to App Store</div> </div> <div> <div className="text-2xl font-bold text-[#FFD700] mb-1">350KB+</div> <div className="text-sm text-gray-300">Documentation across 3 ventures</div> </div> <div> <div className="text-2xl font-bold text-[#FFD700] mb-1">7 prototypes</div> <div className="text-sm text-gray-300">Working demos, not mockups</div> </div> </div> <p className="text-sm text-gray-300 mt-4"> This isn't theoretical. We've already built 3 ventures with complete roadmaps and working prototypes. Every engagement compounds our execution capability. </p> </div> {/* Light Touch on Structure */} <div className="text-center"> <p className="text-sm text-gray-300 mb-4"> Complete investor documentation including PPM, term sheets, and quarterly performance reporting. Institutional-grade structure designed for clarity and liquidity optionality. </p> <Link
          ...
          /> </div> <div className="relative z-10 max-w-4xl mx-auto"> <h2 className="text-3xl sm:text-4xl font-bold mb-8">Use of Funds</h2> <OS8Window
            ...
            variant="body"
            animateIn={false}
          > <div className="space-y-6"> <div> <h3 className="text-lg font-semibold text-white mb-3">Capital Allocation</h3> <div className="space-y-3"> <div className="flex items-center justify-between p-3 rounded-lg bg-black/40 border border-[#FFD700]/20"> <div> <div className="text-sm font-semibold text-white">Engineering Bandwidth</div> <div className="text-xs text-gray-300">Remove execution bottleneck</div> </div> <div className="text-lg font-bold text-[#FFD700]">60%</div> </div> <div className="flex items-center justify-between p-3 rounded-lg bg-black/40 border border-[#FFD700]/20"> <div> <div className="text-sm font-semibold text-white">Founder Focus Protection</div> <div className="text-xs text-gray-300">Sustain conviction-first cycles</div> </div> <div className="text-lg font-bold text-[#FFD700]">30%</div> </div> <div className="flex items-center justify-between p-3 rounded-lg bg-black/40 border border-[#FFD700]/20"> <div> <div className="text-sm font-semibold text-white">Operations & Infrastructure</div> <div className="text-xs text-gray-300">Tools, services, validation</div> </div> <div className="text-lg font-bold text-[#FFD700]">10%</div> </div> </div> </div> <div className="p-4 rounded-lg border-2 border-[#FFD700]/30 bg-[#FFD700]/5"> <h4 className="text-sm font-semibold text-white mb-2">Founder Runway Philosophy</h4> <p className="text-xs text-gray-300 mb-3"> Compensation reflects only essential living needs: high-cost geography + supporting 3 dependent children. Explicitly excludes child support/alimony obligations (managed outside company). </p> <p className="text-xs text-white font-medium"> Purpose: Protect focus and continuity. Benefit: Reduces execution risk for investors. </p> </div> </div> </OS8Window> <div className="text-center mt-6"> <p className="text-sm text-gray-300 mb-6"> This capital accelerates IP velocity, not headcount. Lean, systematic, conviction-driven. </p> <Link
              href="/invest/studio/data-room"
              className="inline-block px-6 py-3 bg-[#FFD700] text-black rounded-lg hover:bg-[#FFD700]/90 transition-colors font-medium"
