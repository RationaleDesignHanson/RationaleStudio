/**
 * Project Atlas Investment Opportunity
 *
 * CRE intelligence platform partnership + capital opportunity
...
export const metadata: Metadata = {
  title: 'Project Atlas — Rationale Investment Opportunities',
  description: 'CRE intelligence platform with complete 12-week roadmap. $165K budget, seeking strategic partner.',
};

export default function AtlasOpportunityPage() {
  const atlasOpp = investmentContent.opportunities.find(o => o.id === 'atlas')!;
          ...
          <div className="max-w-4xl mx-auto">
            <GlassCard theme={heroTheme} className="p-6 sm:p-8 lg:p-12" borderRadius="1.5rem">
              ...
              <div className="flex items-center gap-3 mb-4">
                <span className="text-4xl">{atlasOpp.icon}</span>
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold" style={{ color: heroTheme.foreground }}>
                  {atlasOpp.title}
                </h1>
              </div>
              <p className="text-2xl mb-4" style={{ color: heroTheme.accent }}>{atlasOpp.subtitle}</p>
              <p className="text-base leading-relaxed" style={{ color: heroTheme.muted }}>{atlasOpp.description}</p>
            </GlassCard>
          </div>
        </Container>
      </Section>
          ...
          <div className="max-w-5xl mx-auto">
            <GlassCard theme={tiersTheme} className="p-6 sm:p-8 lg:p-12" borderRadius="1.5rem">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {atlasOpp.highlights.map((highlight, idx) => (
                  <div
                    key={idx}
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-base" style={{ color: comparisonTheme.muted }}>
                    Commercial real estate brokers spend 60-70% of their time on manual research, data entry, and administrative work instead of building relationships and closing deals. This costs firms $65K/year per broker in lost productivity.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-base" style={{ color: comparisonTheme.muted }}>
                    Atlas is an AI-powered CRE intelligence platform that automates property research, market analysis, and deal tracking. Brokers get instant insights, automated workflows, and a unified view of their pipeline—saving 15-20 hours per week.
                  </p>
                </div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-base" style={{ color: comparisonTheme.muted }}>
                        <strong style={{ color: comparisonTheme.foreground }}>103KB complete technical roadmap</strong> covering architecture, features, and 12-week build plan
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span style={{ color: comparisonTheme.accent }}>•</span>
                      <span className="text-base" style={{ color: comparisonTheme.muted }}>
                        <strong style={{ color: comparisonTheme.foreground }}>Market validated</strong> through interviews with 15+ CRE brokers and firm owners
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span style={{ color: comparisonTheme.accent }}>•</span>
                      <span className="text-base" style={{ color: comparisonTheme.muted }}>
                        <strong style={{ color: comparisonTheme.foreground }}>Ready to build</strong> as soon as strategic partner commits
                      </span>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-base" style={{ color: heroTheme.muted }}>
                        <strong style={{ color: heroTheme.foreground }}>Strategic Partner:</strong> CRE firm, PropTech investor, or industry operator with access to pilot customers
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span style={{ color: heroTheme.accent }}>•</span>
                      <span className="text-base" style={{ color: heroTheme.muted }}>
                        <strong style={{ color: heroTheme.foreground }}>Capital:</strong> $165K to fund 12-week MVP build (can be cash or equity equivalent)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span style={{ color: heroTheme.accent }}>•</span>
                      <span className="text-base" style={{ color: heroTheme.muted }}>
                        <strong style={{ color: heroTheme.foreground }}>Distribution:</strong> Pilot commitment from 5-10 brokers for beta testing
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <span style={{ color: heroTheme.accent }}>•</span>
                      <span className="text-base" style={{ color: heroTheme.muted }}>
                        <strong style={{ color: heroTheme.foreground }}>Equity stake:</strong> Negotiable based on capital + strategic value
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span style={{ color: heroTheme.accent }}>•</span>
                      <span className="text-base" style={{ color: heroTheme.muted }}>
                        <strong style={{ color: heroTheme.foreground }}>Production-ready MVP:</strong> 12 weeks from kickoff
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span style={{ color: heroTheme.accent }}>•</span>
                      <span className="text-base" style={{ color: heroTheme.muted }}>
                        <strong style={{ color: heroTheme.foreground }}>Advisory role:</strong> Input on roadmap, features, and GTM strategy
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span style={{ color: heroTheme.accent }}>•</span>
                      <span className="text-base" style={{ color: heroTheme.muted }}>
                        <strong style={{ color: heroTheme.foreground }}>First-mover advantage:</strong> Deploy in your network before public launch
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl font-bold mb-6" style={{ color: getSectionTheme('cta').foreground }}>
              Interested in Project Atlas?
            </h2>
            <p className="text-base sm:text-lg mb-8" style={{ color: getSectionTheme('cta').muted }}>
              Schedule a call to review the complete 103KB technical roadmap, discuss partnership structure, and explore how Atlas fits your CRE strategy.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <ButtonPrimary href="/contact" size="lg">
                Schedule Atlas Discussion
              </ButtonPrimary>
