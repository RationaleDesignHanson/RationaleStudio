...
export const BEATS: Beat[] = [
  ...
  },
  {
    ...
    note: 'Marks built from the name in the face you picked. Change either and the whole family changes with it.',
  },
  {
    n: '04',
    short: 'Applied',
    title: 'On the clothes',
    note: 'The identity on different styles — and which applications survive being made.',
  },
  {
    n: '05',
    short: 'Costs',
