...
export const BEATS: Beat[] = [
  {
    n: '01',
    short: 'Identity',
    title: 'Name it, and add a symbol',
    note: 'The name, the symbol and how the two get used — one decision, because a wordmark and a symbol that share nothing are two brands. The monogram is derived from the name in the same face, so changing one changes both.',
  },
  {
    n: '02',
    short: 'Direction',
  ...
  },
  {
    n: '05',
    short: 'Applied',
    title: 'How it looks made',
    note: 'Now that the direction is set, the identity applied — the family, and where it breaks.',
  },
  {
    n: '06',
    short: 'Standing',
