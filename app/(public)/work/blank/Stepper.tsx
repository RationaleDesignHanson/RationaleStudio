...
export const BEATS: Beat[] = [
  {
    ...
    short: 'Name',
    title: 'Name it',
    note: 'The word. Set in real type, so it is always spelled correctly and costs nothing to try.',
  },
  {
    n: '02',
    short: 'How it looks',
    title: 'How it looks',
    note: 'The name set twelve ways. Pick the face — everything after this inherits it.',
  },
  {
    n: '03',
    short: 'As a mark',
    title: 'How it looks as a mark',
    note: 'Marks built from the name in the face you picked. Shuffle for a different set, then bake off drawn versions of the one you like.',
  },
  {
    n: '04',
    short: 'Colour',
  ...
  },
  {
    ...
    note: 'The identity on different styles, the direction it sits in, and a real render when you want one.',
  },
  {
    n: '06',
    short: 'Costs',
    title: 'Dial in the costs',
    note: 'Now the money. What the run costs, what it sells for, and what the collection saves by being bought as one.',
  },
  {
    n: '07',
    short: 'Standing',
