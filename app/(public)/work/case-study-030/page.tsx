/**
 * Case Study 030: Live Sports Streaming Platform Partnership
 *
 * PASSWORD-PROTECTED
 * Password: 123456
 * Robots: noindex
 ...
 * system built for a live sports streaming platform partnership.
 */
...
import { ExternalLink, Zap, Layers, Palette, ArrowLeft } from 'lucide-react';
        ...
        <section className="py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-4 sm:px-6 md:px-8 border-b border-gray-800">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-xs sm:text-sm font-mono text-terminal-gold tracking-widest mb-4">
              {' '}
              STRATEGIC SPRINT // 2-WEEK DELIVERY // 2024{' '}
            </p>{' '}
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed max-w-3xl mb-6">
              {' '}
              AI-powered sports thumbnail generation with 24 visual styles, enabling scalable
              content creation for FUBO's streaming platform across 200+ teams and 8 major
              leagues.{' '}
            </p>{' '}
            ...
            >
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <p className="text-base">
                  {' '}
                  <span className="font-bold text-black">Challenge:</span> Sports streaming
                  platforms need massive amounts of stylized thumbnail content across hundreds of
                  teams and events. FUBO required a system to generate brand-consistent thumbnails
                  for 200+ teams across 8 major leagues (NFL, NBA, NHL, MLS, EPL, La Liga,
                  Bundesliga, F1) without manual design bottlenecks.{' '}
                </p>{' '}
                <p className="text-base">
                  {' '}
                  <span className="font-bold text-black">Solution:</span> Built AI-powered
                  generation system using Google Gemini 2.5 Flash with 24 visual styles, two-step
                  generation process, and sport-aware styling. Complete system delivered in 2-week
                  strategic sprint with bulk processing, style blending, and quality assurance.{' '}
                </p>{' '}
                ...
                <div className="space-y-3 text-sm text-gray-300">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      {' '}
                      Input: Team name, colors, sport context → Output: Subject-preserved base
                      image{' '}
                    </p>{' '}
                  </div>{' '}
                  <div>
                    {' '}
                    <span className="font-semibold text-white">Step 2: Style Application</span>{' '}
                    <p className="text-xs text-gray-400 mt-1">
                      {' '}
                      Input: Base image + style references + weights → Output: Stylized
                      thumbnail{' '}
                    </p>{' '}
                  </div>{' '}
                </div>{' '}
...
# Comic Book (70%) + Neon Noir (30%)`}
              ...
              <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                  ...
                  <div>
                    {' '}
                    <span className="font-semibold text-white">NFL</span>{' '}
                    <p className="text-xs text-gray-400">32 teams</p>{' '}
                  </div>{' '}
                  <div>
                    {' '}
                    <span className="font-semibold text-white">NBA</span>{' '}
                    <p className="text-xs text-gray-400">30 teams</p>{' '}
                  </div>{' '}
                  <div>
                    {' '}
                    <span className="font-semibold text-white">NHL</span>{' '}
                    <p className="text-xs text-gray-400">32 teams</p>{' '}
                  </div>{' '}
                  <div>
                    {' '}
                    <span className="font-semibold text-white">MLS</span>{' '}
                    <p className="text-xs text-gray-400">29 teams</p>{' '}
                  </div>{' '}
                  <div>
                    {' '}
                    <span className="font-semibold text-white">EPL</span>{' '}
                    <p className="text-xs text-gray-400">20 teams</p>{' '}
                  </div>{' '}
                  <div>
                    {' '}
                    <span className="font-semibold text-white">La Liga</span>{' '}
                    <p className="text-xs text-gray-400">20 teams</p>{' '}
                  </div>{' '}
                  <div>
                    {' '}
                    <span className="font-semibold text-white">Bundesliga</span>{' '}
                    <p className="text-xs text-gray-400">18 teams</p>{' '}
                  </div>{' '}
                  <div>
                    {' '}
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">
                {' '}
                Fully functional thumbnail generator with 11 visual styles, 200+ teams, and
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-400 mb-6">
                    {' '}
                    Launch the working prototype to generate thumbnails in real-time. Requires
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-gray-300">
                  ...
                  <li> 200+ sports teams (8 leagues)</li> <li> Real-time AI generation (3-5s)</li>{' '}
                  <li> Style blending (up to 3 styles)</li> <li> Bulk processing workflows</li>{' '}
                </ul>{' '}
              </div>{' '}
              <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
                {' '}
                ...
                <ul className="space-y-2 text-sm text-gray-300">
                  {' '}
                  <li> Professional background removal</li> <li> Custom overlay graphics system</li>{' '}
                  <li> Quality assurance scoring</li> <li> Organized export system</li>{' '}
                  <li> Custom dimensions support</li> <li> Import/export workflows</li>{' '}
                </ul>{' '}
              </div>{' '}
            </div>{' '}
            <div className="mt-8 p-6 bg-gray-900/30 border border-gray-800 rounded-lg">
              ...
              <p className="text-sm text-gray-400">
                {' '}
                <span className="font-semibold text-white">Timeline:</span> Complete system
                delivered in 2-week strategic sprint from concept to working prototype with full
