  ...
  return (
    ...
    >
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 border-b border-gray-800">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-center">The Agency Paradox</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
              <h3 className="text-xl font-bold text-cyan-400 mb-4">Current State</h3>
            ...
            <div className="p-6 bg-gray-900/50 border border-cyan-400/30 rounded-lg">
              <h3 className="text-xl font-bold text-cyan-400 mb-4">The Breakthrough</h3>
              <ul className="space-y-3 text-gray-300">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 border-b border-gray-800">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-center">Four Integrated Modules</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {/* Module 1 */}
            <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
              <div className="text-cyan-400 font-mono text-sm mb-2">MODULE 1</div>
              <h3 className="text-2xl font-bold mb-3">Digital Twins</h3>
            ...
            <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
              ...
              <h3 className="text-2xl font-bold mb-3">Immersive Pitch System</h3>
              <p className="text-gray-400 mb-4">
            ...
            <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
              ...
              <h3 className="text-2xl font-bold mb-3">Vision Pro Interface</h3>
              <p className="text-gray-400 mb-4">
            ...
            <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
              ...
              <h3 className="text-2xl font-bold mb-3">RecruitAI Assistant</h3>
              <p className="text-gray-400 mb-4">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 border-b border-gray-800">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-center">16-Week Pilot Program</h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 border-b border-gray-800">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-center">Success Metrics</h2>
