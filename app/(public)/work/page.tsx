...
const workBlocks: EraBlockData[] = [
  {
    ...
    rows: (
      <>
        ...
        <WorkRow theme="now" href="/work/zero" index="03" title="Zero" blurb="Shortform email. Swipe-first triage with AI-extracted action items. Shipped cross-platform, then deprioritized — read why." meta="Cross-platform · deprioritized" />
        <WorkRow theme="now" href="/work/vault" index="✱" gated title="Vault" blurb="Confidential client work and concept ventures. Locked — request access." meta="Confidential · client + concept" accentVar="var(--project-vault)" />
      </>
    ),
  },
  {
