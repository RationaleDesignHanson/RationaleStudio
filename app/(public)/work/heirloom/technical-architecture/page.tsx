...
// app/work/heirloom/technical-architecture/page.tsx
// Heirloom Technical Architecture Detail Page

import Link from 'next/link'
import { TechnicalStack } from '../components/_StubComponents'
import FinalCTA from '../components/FinalCTA'

export default function HeirloomTechnicalArchitecturePage() {
  return (
    <main className="heirloom-technical-architecture-page">
      ...
      <section className="bg-white py-6 border-b border-gray-200">
        <div className="container mx-auto px-6 md:px-12 lg:px-16">
          <nav className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="font-semibold text-[#2D2D2D]">Technical Architecture</span>
          </nav>
        </div>
      </section>
