  ...
  return (
    <div className="rounded-2xl border-2 border-[#E85D4D] bg-gradient-to-br from-[#F5F1E8] to-white p-8 shadow-xl">
      <div className="mb-6 flex items-center gap-3">
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#E85D4D] text-2xl text-white">
          ⚡
        </div>
      ...
      <div className="mb-6 grid gap-4 md:grid-cols-3">
        ...
        <div className="rounded-lg border border-[#E85D4D]/20 bg-white p-4">
          <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-gray-500">Quality</div>
          <div className="text-3xl font-bold text-[#E85D4D]">99.1%</div>
          <div className="mt-1 text-sm text-gray-700">Crash-free rate</div>
          <div className="mt-2 text-xs text-[#2A9D8F]">✓ NPS 78 (Strong PMF)</div>
        </div>
      ...
      <div className="mb-6 space-y-4 text-sm">
        <div>
          <span className="font-semibold text-[#2D2D2D]">The Challenge:</span>
          <span className="text-gray-700">
            {' '}Recipe apps treat recipes like spreadsheet data—no personalization, poor sharing, disconnected from cooking workflow.
          </span>
        </div>
        ...
        <div>
          ...
          <span className="text-gray-700">
            {' '}Native iOS app that preserves recipes as beautiful, customizable cards with vintage aesthetics. Integrates smart shopping lists
            via iOS Reminders and supports 500+ recipe sites.
          </span>
        </div>
        ...
        <div>
          ...
          <span className="text-gray-700">
            {' '}Achieved strong product-market fit (NPS 78) in beta with 42 testers. 95% satisfaction during customization phase validates
            differentiation. Production-ready quality (99.1% crash-free) in 5-week sprint.
          </span>
        </div>
      </div>
