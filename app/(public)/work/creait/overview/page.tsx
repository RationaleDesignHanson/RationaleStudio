      ...
      <section className="py-8 md:py-12 lg:py-16 px-4 sm:px-6 lg:px-4 sm:px-6 md:px-8 border-b border-gray-800">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:p-4 md:p-6 lg:p-8">
            <div className="p-4 md:p-6 bg-gray-900/50 border border-green-500/30 rounded-lg">
              <h3 className="text-lg md:text-xl font-bold text-green-400 mb-4">What's Working</h3>
      ...
      <section className="py-8 md:py-12 lg:py-16 px-4 sm:px-6 lg:px-4 sm:px-6 md:px-8 border-b border-gray-800">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            {/* Week 10-12 */}
            <div className="p-4 md:p-6 bg-gray-900/50 border border-amber-400/30 rounded-lg">
              <div className="flex items-center gap-4 mb-3">
          ...
          <div className="grid md:grid-cols-3 gap-4 md:p-6">
            <div className="p-4 md:p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
              <div className="text-amber-400 mb-3">
                <Presentation className="w-4 h-4 md:w-5 md:h-5 md:w-6 md:h-6 md:w-8 md:h-8 md:w-10 md:h-10" />
              </div>
              <h3 className="text-lg md:text-xl font-bold mb-3">Investor-Ready Materials</h3>
            ...
            <div className="p-4 md:p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
              <div className="text-amber-400 mb-3">
                <Rocket className="w-4 h-4 md:w-5 md:h-5 md:w-6 md:h-6 md:w-8 md:h-8 md:w-10 md:h-10" />
              </div>
              <h3 className="text-lg md:text-xl font-bold mb-3">Scalable Technical Foundation</h3>
              <p className="text-gray-400 text-sm">
            ...
            <div className="p-4 md:p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
              <div className="text-amber-400 mb-3">
                <ArrowRight className="w-4 h-4 md:w-5 md:h-5 md:w-6 md:h-6 md:w-8 md:h-8 md:w-10 md:h-10" />
              </div>
              <h3 className="text-lg md:text-xl font-bold mb-3">Go-to-Market Strategy</h3>
              <p className="text-gray-400 text-sm">
      ...
      <section className="py-8 md:py-12 lg:py-16 px-4 sm:px-6 lg:px-4 sm:px-6 md:px-8 border-b border-gray-800">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="p-4 md:p-4 md:p-6 lg:p-8 bg-gray-900/50 border border-amber-400/30 rounded-lg">
              <div className="grid md:grid-cols-2 gap-4 md:p-4 md:p-6 lg:p-8">
                <div>
                  <div className="text-sm text-amber-400 mb-2 font-semibold uppercase tracking-wider">Duration</div>
                  <div className="text-3xl font-bold mb-3 md:mb-6">12 Weeks</div>
                ...
                <div>
                  ...
                  <div className="text-gray-300 text-sm space-y-1 mb-3 md:mb-6">
