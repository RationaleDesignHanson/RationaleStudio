 ...
 *
 * Authentication-protected case study for enterprise B2B platform
 * Access: Owner, Investor, Partner, Team roles + Creait client
 * Robots: noindex
 */
...
// Client access mapping for this case study
const ALLOWED_CLIENT_IDS = ['creait'];
  ...
  useEffect(() => {
    if (!loading) {
      if (!profile) {
        ...
        router.push('/clients/login?redirect=/work/case-study-010');
      } else {
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-gray-900/50 border border-gray-700 rounded-lg">
                    <div className="text-3xl font-bold text-terminal-gold mb-1">16 weeks</div>
                    <div className="text-sm text-gray-400">Problem → MVP delivery</div>
                  </div>
                  <div className="p-4 bg-gray-900/50 border border-gray-700 rounded-lg">
                    <div className="text-3xl font-bold text-terminal-gold mb-1">Full-stack</div>
                    <div className="text-sm text-gray-400">Python backend + React frontend</div>
                  </div>
                  <div className="p-4 bg-gray-900/50 border border-gray-700 rounded-lg">
                    <div className="text-3xl font-bold text-terminal-gold mb-1">Enterprise</div>
