        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <ButtonPrimary
              ...
              size="lg"
              className="gap-2 inline-flex items-center shadow-lg shadow-[#00FF94]/20 bg-[#00FF94] hover:bg-[#00E085] text-gray-900"
            >
            ...
            {content.hero.ctaSecondary && (
              <ButtonSecondary
                ...
                size="lg"
                className="gap-2 border-[#00FF94]/30 hover:border-[#00FF94] text-[#00FF94]"
              >
