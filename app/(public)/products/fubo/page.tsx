/**
 * Fubo Consumer Marketing Page (030)
 *
...
export const metadata: Metadata = {
  title: fuboMarketingContent.seo.title,
  description: fuboMarketingContent.seo.description,
...
export default function FuboProductPage() {
    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white">
      ...
      <div className="py-8 px-4 text-center border-t border-gray-800">
        <p className="text-sm text-gray-500">
          Fubo Thumbnail System • Built by Rationale Studio
        </p>
      </div>
    </main>
  );
