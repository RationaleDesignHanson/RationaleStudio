...
export default function HomePage() {
  ...
  return (
    ...
    <MultipleStructuredData dataBlocks={structuredData} /> <main className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white"> {/* 1. HERO SECTION - Product Studio Identity */} <section className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800 overflow-hidden"> {/* ASCII Grid Background */} <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            ...
            charSet="default"
          /> </div> <div className="relative z-10 max-w-5xl mx-auto text-center"> <div className="mb-6"> <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-gray-300"> <span className="font-semibold text-white">Rationale: </span> <span className="font-light">A Product Development Company</span> </p> </div> <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6"> We ship products. <br /> Yours and ours. </h1> <p className="text-base sm:text-lg text-gray-300 leading-relaxed max-w-3xl mx-auto mb-6"> Product studio with two engines: proprietary software we build and own, <br /> and strategic partnerships where we transform strategy into shipped products. <br /> Proven at Meta AI Reality Labs. Fee + equity engagements available. </p> <div className="flex justify-center"> <a
              href="/overview"
            ...
            > studio overview <ArrowRight className="w-4 h-4" /> </a> </div> </div> </section> {/* 3. CURRENT FOCUS - Zero Beta + Pipeline */} <section id="current-focus" className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-gray-800"> <div className="absolute inset-0 pointer-events-none"> <ASCIIUnifiedGrid
            opacity={0.04}
            animated={true}
