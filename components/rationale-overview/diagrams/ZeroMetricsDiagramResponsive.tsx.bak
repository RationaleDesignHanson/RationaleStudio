...
const ZeroMetricsDiagram = dynamic(() => import('./ZeroMetricsDiagram'), {
  ssr: false,
  loading: () => <DiagramSkeleton />
});

const ZeroMetricsDiagramMobile = dynamic(() => import('./ZeroMetricsDiagramMobile'), {
  ssr: false,
  loading: () => <DiagramSkeleton />
});
...
export default function ZeroMetricsDiagramResponsive() {
  ...
  return isMobile ? <ZeroMetricsDiagramMobile /> : <ZeroMetricsDiagram />;
}
