 ...
 * 3. Data Flow - Recipe import → processing → storage → sync → share
 */
...
const dataFlowSteps = [
  { id: 1, label: 'URL Paste', icon: '📎' },
  { id: 2, label: 'Fetch & Extract', icon: '🔍' },
  { id: 3, label: 'LLM Fallback', icon: '🤖' },
  { id: 4, label: 'SwiftData Store', icon: '💾' },
  { id: 5, label: 'iCloud Sync', icon: '☁️' },
  { id: 6, label: 'Share Export', icon: '📤' }
];
