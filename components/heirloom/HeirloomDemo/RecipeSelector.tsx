      ...
      <div className="md:hidden space-y-3 px-3">{detectedRecipes.map((recipe, index) => (
          ...
          >
              ...
              >
                ...
                <div
                  className="absolute bottom-1 right-1 text-[9px] font-semibold px-1.5 py-0.5 rounded flex items-center gap-0.5"
                  style={{
                ...
                >
                  ...
                  <span>{confidenceToPercent(recipe.confidence)}%</span>
                </div>
              </div>
