...
const DesktopDiagram = dynamic(() => import('./AmplifyAITimingDiagram'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});

const MobileDiagram = dynamic(() => import('./AmplifyAITimingDiagramMobile'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});
...
export default function AmplifyAITimingDiagramResponsive() {
