...
const DesktopDiagram = dynamic(() => import('./ThreeBottlenecksDiagram'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});

const MobileDiagram = dynamic(() => import('./ThreeBottlenecksDiagramMobile'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});
...
export default function ThreeBottlenecksDiagramResponsive() {
