...
const DesktopDiagram = dynamic(() => import('./DigitalTwinFlowDiagram'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});

const MobileDiagram = dynamic(() => import('./DigitalTwinFlowDiagramMobile'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});
...
export default function DigitalTwinFlowDiagramResponsive() {
