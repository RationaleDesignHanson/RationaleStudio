...
const DesktopDiagram = dynamic(() => import('./SuccessMetricsDiagram'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});

const MobileDiagram = dynamic(() => import('./SuccessMetricsDiagramMobile'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});
...
export default function SuccessMetricsDiagramResponsive() {
