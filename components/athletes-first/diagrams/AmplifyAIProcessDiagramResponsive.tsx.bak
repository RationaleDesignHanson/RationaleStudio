...
const DesktopDiagram = dynamic(() => import('./AmplifyAIProcessDiagram'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});

const MobileDiagram = dynamic(() => import('./AmplifyAIProcessDiagramMobile'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});
...
export default function AmplifyAIProcessDiagramResponsive() {
