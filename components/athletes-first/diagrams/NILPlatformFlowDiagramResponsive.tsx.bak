...
const DesktopDiagram = dynamic(() => import('./NILPlatformFlowDiagram'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});

const MobileDiagram = dynamic(() => import('./NILPlatformFlowDiagramMobile'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});
...
export default function NILPlatformFlowDiagramResponsive() {
