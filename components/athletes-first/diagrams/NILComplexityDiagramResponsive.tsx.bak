...
const DesktopDiagram = dynamic(() => import('./NILComplexityDiagram'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});

const MobileDiagram = dynamic(() => import('./NILComplexityDiagramMobile'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});
...
export default function NILComplexityDiagramResponsive() {
