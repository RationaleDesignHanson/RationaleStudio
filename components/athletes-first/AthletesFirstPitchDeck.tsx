...
const DEMO_COMPONENTS: Record<string, React.ComponentType<any>> = {
  ...
  ThreeBottlenecksDiagram: dynamic(() => import('./diagrams/ThreeBottlenecksDiagramResponsive'), { loading: () => <LoadingComponent /> }),
  StatusQuoCeilingDiagram: dynamic(() => import('./diagrams/StatusQuoCeilingDiagram'), { loading: () => <LoadingComponent /> }),
  NILComplexityDiagram: dynamic(() => import('./diagrams/NILComplexityDiagramResponsive'), { loading: () => <LoadingComponent /> }),
  DigitalTwinFlowDiagram: dynamic(() => import('./diagrams/DigitalTwinFlowDiagramResponsive'), { loading: () => <LoadingComponent /> }),
  ...
  SuccessMetricsDiagram: dynamic(() => import('./diagrams/SuccessMetricsDiagramResponsive'), { loading: () => <LoadingComponent /> }),
  ...
  AmplifyAITimingDiagram: dynamic(() => import('./diagrams/AmplifyAITimingDiagramResponsive'), { loading: () => <LoadingComponent /> }),
  AmplifyAIProcessDiagram: dynamic(() => import('./diagrams/AmplifyAIProcessDiagramResponsive'), { loading: () => <LoadingComponent /> }),
  NILPlatformFlowDiagram: dynamic(() => import('./diagrams/NILPlatformFlowDiagramResponsive'), { loading: () => <LoadingComponent /> }),
  InteractivePitchInterfaceDiagram: dynamic(() => import('./diagrams/InteractivePitchInterfaceDiagramResponsive'), { loading: () => <LoadingComponent /> }),
