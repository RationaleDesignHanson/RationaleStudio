...
export function GannettPitch() {
  return (
    <div className="space-y-12">
      ...
      {/* Why Rationale */}
      <div className="p-8 bg-gradient-to-br from-[#FFD700]/10 to-transparent border border-[#FFD700]/30 rounded-lg">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="flex items-start gap-3">
            <Brain className="w-6 h-6 text-[#FFD700] flex-shrink-0 mt-1" />
            <div>
      ...
      <div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
            <div className="text-[#FFD700] font-bold text-sm mb-2">PHASE 1</div>
          ...
          <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
            <div className="text-[#FFD700] font-bold text-sm mb-2">PHASE 2</div>
          ...
          <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-lg">
            <div className="text-[#FFD700] font-bold text-sm mb-2">PHASE 3</div>
      ...
      <div className="p-8 bg-gray-900/50 border border-gray-700 rounded-lg">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-4">
            <div className="w-16 h-16 bg-[#FFD700]/10 rounded-lg flex items-center justify-center flex-shrink-0">
              <span className="text-2xl font-bold text-[#FFD700]">MH</span>
            </div>
            <div>
              <h3 className="text-lg font-bold text-white">Matt Hanson</h3>
              <p className="text-sm text-[#FFD700] mb-2">Founder & Product Lead</p>
              <p className="text-sm text-gray-400">
      ...
      {/* CTA */}
      <div className="text-center p-12 bg-gradient-to-br from-[#FFD700]/10 via-transparent to-transparent border border-[#FFD700]/30 rounded-lg">
        ...
        <div className="flex gap-4 justify-center">
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-8 py-4 bg-[#FFD700] text-black font-bold rounded-lg hover:bg-[#FFD700]/90 transition-colors text-lg"
          >
