/**
 * CaseStudyLoadingSkeleton — neutral cold-start fallback for open (ungated)
 * case-study routes. Mirrors the era chrome so serverless cold starts feel
 * responsive, without the lock / "Confidential unlock" framing used by
 * UnlockGateSkeleton (which is reserved for routes still behind UnlockGate).
 */
...
export function CaseStudyLoadingSkeleton({ project, era = 'now', title, subtitle, meta }: Props) {
  return (
        ...
        <section className="px-4 sm:px-6 md:px-8 pt-10 md:pt-14 pb-16">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="max-w-2xl">
              {meta && (
                <p className="text-[11px] md:text-xs font-mono text-[var(--accent)] tracking-[0.3em] uppercase mb-3">
                  {meta}
                </p>
              )}
