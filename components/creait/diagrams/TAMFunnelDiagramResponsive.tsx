...
const DesktopDiagram = dynamic(() => import('./TAMFunnelDiagram'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});

const MobileDiagram = dynamic(() => import('./TAMFunnelDiagramMobile'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});
...
export default function TAMFunnelDiagramResponsive() {
