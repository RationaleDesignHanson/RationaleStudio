...
const DesktopDiagram = dynamic(() => import('./ValidationMapDiagram'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});

const MobileDiagram = dynamic(() => import('./ValidationMapDiagramMobile'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});
...
export default function ValidationMapDiagramResponsive() {
