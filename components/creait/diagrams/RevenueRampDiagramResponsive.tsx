...
const DesktopDiagram = dynamic(() => import('./RevenueRampDiagram'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});

const MobileDiagram = dynamic(() => import('./RevenueRampDiagramMobile'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});
...
export default function RevenueRampDiagramResponsive() {
