...
const DesktopDiagram = dynamic(() => import('./BrokerDayDiagram'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});

const MobileDiagram = dynamic(() => import('./BrokerDayDiagramMobile'), {
  ssr: false,
  loading: () => <DiagramSkeleton />,
});
...
export default function BrokerDayDiagramResponsive() {
